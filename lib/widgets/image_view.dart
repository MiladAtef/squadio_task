...
class _ViewPhotosState extends State<ViewPhotos> {
  ...
  Future<void> _save(String imageUrl) async {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () async {
              await _save(widget.imageList[currentIndex].image);
            },
            icon: const Icon(
              Icons.save_alt,
              color: Colors.white,
      ...
      body: PhotoViewGallery.builder(
        ...
        builder: (BuildContext context, int i) {
          return PhotoViewGalleryPageOptions(
            imageProvider: CachedNetworkImageProvider(widget.imageList[i].image),
