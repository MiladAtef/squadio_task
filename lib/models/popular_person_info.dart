...
import '../helpers/formatted_month_generator.dart';

class PopularPersonInfo {
  final String image;
  final String name;
  final String bio;
  final String id;
  ...
  factory PopularPersonInfo.fromJson(json) {
    ...
    try {
      string = "${formattedMonthGenerator(json['birthday'].split("-")[1])} ${json['birthday'].split("-")[2]}, ${json['birthday'].split("-")[0]}";
      // ignore: empty_catches
    } catch (e) {}
    return PopularPersonInfo(
      bio: json['biography'] ?? '',
      birthday: string,
      id: json['id'].toString(),
      ...
      old: json['birthday'] != null ? '${getyears(json['birthday'])} years' : 'N/A',
    );
  }
}
